...
**Un videojuego de citas, misterio y ritmo estilo Cozy que sana el alma al ritmo de la música.**

---

## 📖 Concepto

Mistery House es un juego que combina:
- 🎵 **Mecánicas de Ritmo** (4 carriles interactivos)
- 💝 **Narrativa de Citas y Misterio** (Visual Novel style)
- 🏠 **Ambiente Cozy y Reconfortante** (Acuarela romántica)
- 🧘 **Sesiones de Mindfulness** (25 minutos sin distracciones)
...
| Elemento | Color |
|----------|-------|
| Primario | #FFD1DC (Rosa Pastel) |
| Secundario | #FFF9F5 (Crema Suave) |
| Acento/CTA | #E75480 (Rose Gold) |
| Fondo | #FFF0F5 (Lavender Blush) |

**Tipografía**: Great Vibes / Playfair Display (títulos), Quicksand / Nunito (texto)
...
- [Brief Creativo](./04-Documentacion/BRIEF.md)
- [Guía de Estilo](./04-Documentacion/GUIA_ESTILO.md)

## ✨ Características

✅ Casa Musical transformable en 4 escenarios  
✅ 4 NPCs con narrativa emocional propia  
✅ Sistema de ritmo de 4 carriles interactivo  
✅ Decisiones que impactan la narrativa  
✅ Sesiones de 25 minutos sin distracciones  
✅ Arte estilo acuarela y toon shading  
✅ Música original terapéutica  

## 📝 Licencia

Proyecto desarrollado para el **Tecnólogo en Animación 3D del SENA** (Ficha 3410924)  
Instructor: **Roilan Galleano**

---

*Sana el alma al ritmo de la música. 🎵💕*
